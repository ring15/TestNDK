...
extern "C"
JNIEXPORT jstring JNICALL
Java_com_founq_sdk_testndk_JniUtil_decrypt(JNIEnv *env, jclass type, jstring source_) {
    //调用的方法名
...
extern "C"
JNIEXPORT jstring JNICALL
Java_com_founq_sdk_testndk_JniUtil_encrypt(JNIEnv *env, jclass type, jstring source_) {
